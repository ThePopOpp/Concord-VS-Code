...
|--------------------------------------------------------------------------
|
| If the application is in maintenance mode or demo mode via the "down" command,
| you can still preview it locally by running "php artisan serve" in your terminal.
| This will start a development server, typically at http://localhost:8000.
